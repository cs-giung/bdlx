...
from bdlx.optim import rmsprop
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--centered', default=False, type=str2bool,
        help='use centered RMSProp (default: False)')
    parser.add_argument(
        '--momentum', default=0.0, type=float,
        help='momentum coefficient (default: 0.0)')
    parser.add_argument(
        '--nesterov', default=False, type=str2bool,
        help='use Nesterov accelerated gradient (default: False)')
    parser.add_argument(
        '--smoothing', default=0.99, type=float,
        help='smoothing coefficient in running averaging (default: 0.99)')
    ...
    init_momentum_mu = \
        jax.tree_util.tree_map(jnp.zeros_like, init_position) \
            if args.centered else None
    init_momentum_nu = jax.tree_util.tree_map(jnp.zeros_like, init_position)

    state = rmsprop.RMSPropState(
