...
```
Notation: Mean (Median) ± Std [Min - Max], based on 8 trials.

+--------------+--------------+------------------+----------------------------------+----------------------------------+
| Augmentation | Schedule     | Method           | val/err                          | val/nll                          |
+--------------+--------------+------------------+----------------------------------+----------------------------------+
| none         | cosine       | sgd              | .172 (.173) ± .004 [.167 - .177] | .719 (.715) ± .020 [.693 - .759] |
| none         | cosine       | sgdw             | .176 (.177) ± .003 [.171 - .178] | .736 (.746) ± .026 [.701 - .772] |
| none         | cosine       | msgd             | .151 (.151) ± .004 [.145 - .158] | .646 (.650) ± .020 [.613 - .677] |
| none         | cosine       | msgdw            | .153 (.152) ± .002 [.151 - .155] | .687 (.685) ± .013 [.668 - .704] |
| none         | cosine       | adamw            | .138 (.138) ± .004 [.132 - .144] | .539 (.539) ± .017 [.513 - .560] |
| none         | cosine       | ivon             | .135 (.135) ± .003 [.130 - .139] | .462 (.464) ± .010 [.445 - .474] |
| none         | cosine       | bsam             | .136 (.135) ± .004 [.131 - .141] | .436 (.433) ± .011 [.423 - .458] |
+--------------+--------------+------------------+----------------------------------+----------------------------------+
| simple       | cosine       | sgd              | .105 (.104) ± .002 [.102 - .109] | .388 (.386) ± .008 [.378 - .401] |
| simple       | cosine       | sgdw             | .105 (.105) ± .002 [.101 - .108] | .392 (.393) ± .006 [.384 - .398] |
| simple       | cosine       | msgd             | .096 (.096) ± .002 [.095 - .100]	| .414 (.415) ± .016 [.381 - .435] |
| simple       | cosine       | msgdw            | .095 (.096) ± .003 [.090 - .098] | .344 (.341) ± .011 [.329 - .363] |
| simple       | cosine       | adamw            | .089 (.089) ± .003 [.085 - .093] | .374 (.374) ± .008 [.359 - .385] |
| simple       | cosine       | ivon             | .088 (.088) ± .003 [.081 - .092] | .297 (.297) ± .009 [.280 - .311] |
| simple       | cosine       | bsam             | .088 (.089) ± .002 [.084 - .091] | .284 (.286) ± .007 [.274 - .292] |
+--------------+--------------+------------------+----------------------------------+----------------------------------+
| colour       | cosine       | sgd              | .102 (.102) ± .003 [.096 - .105] | .350 (.351) ± .009 [.339 - .369] |
| colour       | cosine       | sgdw             | .102 (.102) ± .003 [.097 - .108] | .357 (.355) ± .010 [.345 - .374] |
| colour       | cosine       | msgd             | .094 (.093) ± .002 [.092 - .097] | .323 (.321) ± .007 [.314 - .336] |
| colour       | cosine       | msgdw            | .092 (.092) ± .003 [.089 - .097] | .338 (.341) ± .009 [.324 - .349] |
| colour       | cosine       | adamw            | .092 (.091) ± .002 [.089 - .096] | .338 (.338) ± .013 [.313 - .352] |
| colour       | cosine       | ivon             | .089 (.089) ± .002 [.087 - .092] | .285 (.285) ± .007 [.276 - .296] |
| colour       | cosine       | bsam             | .086 (.085) ± .002 [.084 - .090] | .262 (.262) ± .007 [.251 - .271] |
+--------------+--------------+------------------+----------------------------------+----------------------------------+
```
...
| none         | cyclical     | msgld            | .121 (.122) ± .003 [.116 - .127] | .379 (.377) ± .010 [.366 - .401] | .250 (.254) ± .009 [.235 - .260] | 100       |
| none         | cyclical     | asgld            | .108 (.108) ± .003 [.104 - .112] | .335 (.336) ± .004 [.330 - .341] | .313 (.316) ± .011 [.291 - .325] | 100       |
| none         | cyclical     | sghmc            | .132 (.132) ± .003 [.130 - .137] | .409 (.409) ± .005 [.400 - .415] | .181 (.180) ± .006 [.171 - .189] | 100       |
| none         | cyclical     | sgnht            | .136 (.136) ± .002 [.131 - .138] | .424 (.423) ± .006 [.415 - .432] | .191 (.191) ± .004 [.186 - .197] | 100       |
+--------------+--------------+------------------+----------------------------------+----------------------------------+----------------------------------+-----------+
```
...
| Augmentation | Schedule     | Method           | val/err                          | val/nll                          |
+--------------+--------------+------------------+----------------------------------+----------------------------------+
| none         | cosine       | sgd              | .658 (.657) ± .006 [.649 - .668] | 4.14 (4.17) ± .174 [3.85 - 4.39] |
| none         | cosine       | sgdw             | .630 (.633) ± .008 [.618 - .640] | 3.04 (3.01) ± .110 [2.91 - 3.23] |
| none         | cosine       | msgd             | .547 (.543) ± .012 [.538 - .576] | 2.48 (2.47) ± .062 [2.42 - 2.61] |
| none         | cosine       | msgdw            | .542 (.540) ± .008 [.532 - .556] | 2.47 (2.47) ± .053 [2.37 - 2.53] |
| none         | cosine       | adamw            | .535 (.536) ± .008 [.525 - .545] | 2.76 (2.76) ± .074 [2.68 - 2.89] |
| none         | cosine       | ivon             | .452 (.451) ± .004 [.447 - .460] | 1.60 (1.60) ± .012 [1.59 - 1.62] |
| none         | cosine       | bsam             | .454 (.453) ± .008 [.443 - .465] | 1.66 (1.65) ± .044 [1.62 - 1.74] |
+--------------+--------------+------------------+----------------------------------+----------------------------------+
| simple       | cosine       | sgd              | .406 (.408) ± .008 [.393 - .415] | 1.50 (1.49) ± .025 [1.47 - 1.54] |
| simple       | cosine       | sgdw             | .408 (.409) ± .004 [.401 - .413] | 1.51 (1.50) ± .023 [1.47 - 1.55] |
| simple       | cosine       | msgd             | .377 (.378) ± .004 [.371 - .382] | 1.57 (1.56) ± .014 [1.55 - 1.59] |
| simple       | cosine       | msgdw            | .385 (.384) ± .005 [.380 - .395] | 1.42 (1.43) ± .019 [1.40 - 1.45] |
| simple       | cosine       | adamw            | .390 (.390) ± .005 [.382 - .397] | 1.49 (1.49) ± .022 [1.46 - 1.53] |
| simple       | cosine       | ivon             | .353 (.352) ± .005 [.347 - .359] | 1.33 (1.33) ± .018 [1.31 - 1.37] |
| simple       | cosine       | bsam             | .362 (.361) ± .003 [.357 - .366] | 1.31 (1.31) ± .007 [1.30 - 1.32] |
+--------------+--------------+------------------+----------------------------------+----------------------------------+
| colour       | cosine       | sgd              | .382 (.383) ± .006 [.371 - .389] | 1.37 (1.37) ± .018 [1.34 - 1.39] |
| colour       | cosine       | sgdw             | .380 (.380) ± .002 [.375 - .383] | 1.37 (1.37) ± .009 [1.36 - 1.38] |
| colour       | cosine       | msgd             | .363 (.365) ± .006 [.352 - .369] | 1.34 (1.34) ± .020 [1.31 - 1.37] |
| colour       | cosine       | msgdw            | .362 (.364) ± .004 [.356 - .366] | 1.33 (1.33) ± .016 [1.31 - 1.35] |
| colour       | cosine       | adamw            | .371 (.373) ± .004 [.365 - .376] | 1.36 (1.36) ± .015 [1.33 - 1.38] |
| colour       | cosine       | ivon             | .349 (.350) ± .006 [.340 - .355] | 1.27 (1.27) ± .018 [1.24 - 1.29] |
| colour       | cosine       | bsam             | .350 (.350) ± .003 [.346 - .356] | 1.24 (1.24) ± .009 [1.23 - 1.25] |
+--------------+--------------+------------------+----------------------------------+----------------------------------+
```
...
| none         | cyclical     | msgld            | .376 (.376) ± .004 [.368 - .380] | 1.38 (1.38) ± .007 [1.37 - 1.39] | .564 (.565) ± .019 [.542 - .602] | 100       |
| none         | cyclical     | asgld            | .349 (.348) ± .004 [.343 - .356] | 1.30 (1.30) ± .017 [1.29 - 1.33] | .939 (.941) ± .038 [.894 - .983] | 100       |
| none         | cyclical     | sghmc            | .379 (.379) ± .001 [.376 - .379] | 1.41 (1.41) ± .005 [1.41 - 1.42] | .465 (.463) ± .006 [.458 - .475] | 100       |
| none         | cyclical     | sgnht            | .385 (.384) ± .004 [.380 - .394] | 1.45 (1.45) ± .013 [1.43 - 1.48] | .524 (.525) ± .011 [.507 - .537] | 100       |
+--------------+--------------+------------------+----------------------------------+----------------------------------+----------------------------------+-----------+
```
